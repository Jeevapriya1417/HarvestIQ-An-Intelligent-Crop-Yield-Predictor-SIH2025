        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className={`transform transition-all duration-1000 ${heroInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <button
                  ...
                  className="px-8 py-4 rounded-xl border-2 border-green-200 text-green-700 hover:bg-green-50 transition-all duration-300 font-semibold text-lg flex items-center"
                >
                  {t('welcome.learnMore')}
          ...
          <div className={`mt-20 transform transition-all duration-1000 delay-500 ${heroInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="relative max-w-4xl mx-auto">
              <div className="glass rounded-3xl p-8 bg-white/20">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center p-6 rounded-xl bg-white/50">
                    ...
                    <p className="text-sm text-gray-600 mt-2">Advanced ML algorithms</p>
                  </div>
                  <div className="text-center p-6 rounded-xl bg-white/50">
                    <Database className="h-12 w-12 text-green-600 mx-auto mb-4" />
                    <h3 className="font-semibold text-gray-900">Gov Data</h3>
                    <p className="text-sm text-gray-600 mt-2">Real-time integration</p>
                  </div>
                  <div className="text-center p-6 rounded-xl bg-white/50">
                    <TrendingUp className="h-12 w-12 text-orange-600 mx-auto mb-4" />
                    <h3 className="font-semibold text-gray-900">Analytics</h3>
                    <p className="text-sm text-gray-600 mt-2">Actionable insights</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className="group p-8 rounded-2xl bg-gradient-to-br from-white to-gray-50 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
