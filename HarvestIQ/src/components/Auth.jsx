  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-green-200/30"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-green-300/20"></div>
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Auth Card */}
        <div className="glass rounded-2xl p-8 bg-white/80 backdrop-blur-sm border border-white/20 shadow-xl">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-display font-bold text-gray-900">HarvestIQ</span>
            </div>
